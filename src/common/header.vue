<template>
  <div>
    <header class="w">
      <div class="w-box">
        <div class="nav-logo">
          <img src="../assets/images/chong.jpg" alt="" srcset="">
        </div>
        <div class="right-box">
          <div class="nav-list">
          ...
          <div class="nav-aside" ref="aside">
            ...
            <div class="shop pr" ref="positionMsg">
              <router-link to="/cart">
                <span class="cart-num">
...
<style>
  ...
  .nav-sub .nav-list2 li:first-child {
    padding-left: 0;
  }

  .nav-sub .nav-list2 li {
    position: relative;
    float: left;
    padding-left: 2px;
  }
  .nav-sub .nav-list2 li:first-child a {
    padding-left: 10px;
  }
  .nav-sub .nav-list2 li a {
    display: block;
    padding: 0 10px;
    color: #666;
  }
